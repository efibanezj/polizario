...
@NoArgsConstructor
@AllArgsConstructor
public class YpNotFoundException extends RuntimeException {
     ...
     */
    public YpNotFoundException(BusinessExceptionEnum clientErrorCode) {
        super(clientErrorCode.name());
        this.errorCode = clientErrorCode.getValue();
    }

    public YpNotFoundException(String message) {
        super(message);
    }
